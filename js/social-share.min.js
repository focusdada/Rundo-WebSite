...
! function() {
	...
	function s(t, e) {
		for(var r = 1, i = h(t), n = 0, o = p.length; n <= o; n++) {
			var a = 0;
			switch(e) {
				case u.L:
					a = p[n][0];
	...
	t.prototype = {
		...
		setupPositionProbePattern: function(t, e) {
			for(var r = -1; r <= 7; r++)
				if(!(t + r <= -1 || this.moduleCount <= t + r))
					for(var i = -1; i <= 7; i++) e + i <= -1 || this.moduleCount <= e + i || (0 <= r && r <= 6 && (0 == i || 6 == i) || 0 <= i && i <= 6 && (0 == r || 6 == r) || 2 <= r && r <= 4 && 2 <= i && i <= 4 ? this.modules[t + r][e + i] = !0 : this.modules[t + r][e + i] = !1)
		},
			...
			for(var t = d.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++)
				for(var r = 0; r < t.length; r++) {
					...
					if(null == this.modules[i][n])
						for(var o = -2; o <= 2; o++)
							for(var a = -2; a <= 2; a++) o == -2 || 2 == o || a == -2 || 2 == a || 0 == o && 0 == a ? this.modules[i + o][n + a] = !0 : this.modules[i + o][n + a] = !1
				}
		},
		...
		setupTypeInfo: function(t, e) {
			for(var r = this.errorCorrectLevel << 3 | e, i = d.getBCHTypeInfo(r), n = 0; n < 15; n++) {
				var o = !t && 1 == (i >> n & 1);
				...
				for(6 == a && a--;;) {
					for(var s = 0; s < 2; s++)
						if(null == this.modules[i][a - s]) {
							...
							l && (h = !h), this.modules[i][a - s] = h, n--, n == -1 && (o++, n = 7)
						}
					if(i += r, i < 0 || this.moduleCount <= i) {
						i -= r, r = -r;
						break
					}
				}
		...
		for(var w = new Array(v), _ = 0, c = 0; c < n; c++)
	...
	for(var l = {
			...
			getErrorCorrectPolynomial: function(t) {
				for(var e = new r([1], 0), i = 0; i < t; i++) e = e.multiply(new r([1, f.gexp(i)], 0));
				return e
			},
			...
			getLostPoint: function(t) {
				...
				for(var i = 0; i < e; i++)
					for(var n = 0; n < e - 6; n++) t.isDark(i, n) && !t.isDark(i, n + 1) && t.isDark(i, n + 2) && t.isDark(i, n + 3) && t.isDark(i, n + 4) && !t.isDark(i, n + 5) && t.isDark(i, n + 6) && (r += 40);
				for(var n = 0; n < e; n++)
					for(var i = 0; i < e - 6; i++) t.isDark(i, n) && !t.isDark(i + 1, n) && t.isDark(i + 2, n) && t.isDark(i + 3, n) && t.isDark(i + 4, n) && !t.isDark(i + 5, n) && t.isDark(i + 6, n) && (r += 40);
				for(var u = 0, n = 0; n < e; n++)
					for(var i = 0; i < e; i++) t.isDark(i, n) && u++;
		...
		}, g = 0; g < 8; g++) f.EXP_TABLE[g] = 1 << g;
	for(var g = 8; g < 256; g++) f.EXP_TABLE[g] = f.EXP_TABLE[g - 4] ^ f.EXP_TABLE[g - 5] ^ f.EXP_TABLE[g - 6] ^ f.EXP_TABLE[g - 8];
	for(var g = 0; g < 255; g++) f.LOG_TABLE[f.EXP_TABLE[g]] = g;
	r.prototype = {
		get: function(t) {
			return this.num[t]
		},
...
function(t, e, r) {
	...
	function n(t, e) {
		...
		v(i ? r.reverse() : r, function(r) {
			...
			return !o.length || (o[0].href = n, "wechat" === r ? o[0].tabindex = -1 : o[0].target = "_blank", void(e.initialized || (i ? t.insertBefore(o[0], t.firstChild) : t.appendChild(o[0]))))
		})
	}
...
//		})
	...
	function p(t) {
		...
		return t.hasAttributes() ? (v(t.attributes, function(t) {
			var r = t.name;
			return 0 !== r.indexOf("data-") || (r = r.replace(/^data-/i, "").replace(/-(\w)/g, function(t, e) {
	...
	function v(t, e) {
		...
		if(i === r) {
			...
			for(var o = 0; o < i && e.call(t[o], t[o], o) !== !1; o++);
	}
